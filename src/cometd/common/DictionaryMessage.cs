    ...
    public class DictionaryMessage : Dictionary<String, Object>, IMutableMessage
    {
        ...
        public IDictionary<String, Object> Advice
        {
            get
            {
                ...
                if (advice != null)
                {
                    var adviceParameters = JsonConvert.DeserializeObject<Dictionary<String, Object>>(advice.ToString());

                    this[Message_Fields.ADVICE_FIELD] = adviceParameters;
                    return (IDictionary<String, Object>)adviceParameters;
                }
