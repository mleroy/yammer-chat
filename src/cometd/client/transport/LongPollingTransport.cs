...
namespace Cometd.Client.Transport
{
    ...
    public class LongPollingTransport : HttpClientTransport
    {
        ...
        public override void send(ITransportListener listener, IList<IMutableMessage> messages)
        {
            ...
            // TODO: do we need cookies? need to set appropriate URI
            //request.CookieContainer.Add(new Uri("https://www.yammer.com"), getCookieCollection()); 
        ...
        private static void GetRequestStreamCallback(IAsyncResult asynchronousResult)
        {
            ...
            try
            {
                ...
                IAsyncResult result = (IAsyncResult)exchange.request.BeginGetResponse(asyncResult =>
                {
